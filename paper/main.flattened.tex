...
\date{5 February 2026\\[4pt]{\small Version 2 (revised 27 February 2026) \quad$\cdot$\quad Zenodo v1: \href{https://doi.org/10.5281/zenodo.18494975}{10.5281/zenodo.18494975}}}
...
We use a lazy random walk on an $n\times n$ grid with von Neumann neighborhood (up/down/left/right) and stay-put probability.  This is a standard substrate with isotropic local moves.  It supports E1 (plane-like metric) and serves as the flat baseline for holonomy comparisons.
...
\paragraph{Code availability.}
Source code is available at \url{https://github.com/ioannist/six-birds-space}. A permanent archive of the code is deposited at Zenodo under DOI \href{https://doi.org/10.5281/zenodo.18595948}{10.5281/zenodo.18595948}.
